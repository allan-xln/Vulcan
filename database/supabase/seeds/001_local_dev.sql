...
insert into public.permissions (
  ...
  ('00000000-0000-0000-0000-000000000204', 'operational_events.manage', 'Manage operational events', 'Manage operational event policies and agent approvals.', 'operational_event', 'manage'),
...
insert into public.operational_event_policies (
  id,
  tenant_id,
  policy_key,
  name,
  ...
  (
    ...
    'Baseline workstation observability',
    'Collect approved osquery operational event signals only.',
    true,
    '{
...
set
  ...
  operational_event_count = excluded.operational_event_count,

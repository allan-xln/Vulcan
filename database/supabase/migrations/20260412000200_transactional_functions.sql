...
drop trigger if exists trg_operational_event_policies_set_audit_fields on public.operational_event_policies;
create trigger trg_operational_event_policies_set_audit_fields
before insert or update on public.operational_event_policies
for each row execute function app_private.set_audit_fields();
...
drop trigger if exists trg_operational_event_policies_audit on public.operational_event_policies;
create trigger trg_operational_event_policies_audit
after insert or update or delete on public.operational_event_policies
for each row execute function app_private.write_audit_log();

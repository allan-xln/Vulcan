...
SchemaVersion = Literal["2026-06-operational-events.v1"]
...
class OperationalEventBatchRequest(BaseModel):
    ...
    events: list[OperationalEvent] = Field(min_length=1, max_length=500)
...
class OperationalEventBatchResponse(BaseModel):

...
from app.schemas import OperationalEventBatchRequest
...
def make_batch(event_id: str, workstation_id: str = "00000000-0000-0000-0000-000000000901") -> OperationalEventBatchRequest:
    return OperationalEventBatchRequest.model_validate(
        {
            "schemaVersion": "2026-06-operational-events.v1",
            "batchId": "batch-001",
...
def test_ingests_valid_batch() -> None:
    ...
    service = OperationalEventIngestionService(repository=repository)

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize accepted raw operational event intake into deterministic operational events.")
...
def main() -> int:
    args = parse_args()
    database_url = os.getenv("DATABASE_URL", "postgresql://postgres:postgres@127.0.0.1:5432/vulcan")
